...
parametros_ventana = {'element_justification' : 'center', 'auto_size_text' : True, 'auto_size_buttons' : True, 'finalize' : True, 'use_default_focus' : False, 'text_justification' : 'center', 'disable_close' : True}
